    ...
    return (
        <article className='max-w-5xl mx-auto leading-relaxed space-y-10'>
            <section className='border-b pb-6 pt-20'>
                <h2 className='mb-2 text-center'>Privacy Policy</h2>
                ...
                <p className='mt-2'>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>
            </section>
            <section>
            ...
            <section>
                <h3 className='mb-2'>Information from Third-Party Social Media Services</h3>
            ...
            <section>
                ...
                <h5 className='mt-2'>Business Transactions</h5>
                <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                <h5 className='mt-2'>Law enforcement</h5>
                <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
                <h5 className='mt-2'>Other legal requirements</h5>
            ...
            <section>
                <h3 className='mb-2'>Links to Other Websites</h3>
