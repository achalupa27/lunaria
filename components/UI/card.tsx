...
const cardVariants = cva('w-auto rounded-2xl bg-white border-orange-50 border px-6 py-4 shadow transition duration-200 dark:border-zinc-800 dark:bg-gray-950', {
    variants: {
        variant: {
            default: '',
