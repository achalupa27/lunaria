    ...
    return (
        <div className='flex min-h-screen flex-col-reverse items-center justify-around px-12 pb-36 lg:flex-row lg:pb-12 2xl:px-0'>
            <div className='h-1/2 md:ml-16 md:mt-16 md:h-auto'>
                ...
                <div className='mt-8 flex flex-col space-y-2 lg:flex-row lg:space-x-3 lg:space-y-0'>
                    {user ? (
            ...
            <div className='flex basis-1/2 items-center justify-center lg:pb-16 lg:pl-16 lg:pr-16'>
                <div className='relative h-[32rem] w-[32rem] 2xl:h-[48rem] 2xl:w-[48rem]'>
                    <Image fill alt='banner' object-fit='contain' src={theme === 'light' ? '/banner.svg' : '/banner.svg'} />
                </div>
            </div>
        </div>
    );
