...
const Toaster = ({ ...props }: ToasterProps) => {
    ...
    return (
        <Sonner
            ...
            className='toaster group border-orange-100'
            toastOptions={{
                classNames: {
                    toast: 'group toast group-[.toaster]:bg-white group-[.toaster]:text-zinc-950 group-[.toaster]:border-orange-100 group-[.toaster]:shadow-lg dark:group-[.toaster]:bg-zinc-950 dark:group-[.toaster]:text-zinc-50 dark:group-[.toaster]:border-zinc-800 border-orange-100',
