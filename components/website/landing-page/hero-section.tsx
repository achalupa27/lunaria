...
const HeroSection = () => {
    ...
    return (
        <section className='flex flex-col items-center border-t dark:border-t-0'>
            ...
            <motion.div initial={{ y: 0, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1.5, delay: 1.75 }} className='mt-12 flex flex-col items-center'>
                ...
                <span className='text-zinc-700 dark:text-zinc-400 md:text-2xl'>Watch your money grow.</span>
            </motion.div>
