    ...
    return (
        <div>
            <div className='bg-zing-50 flex min-h-screen flex-col items-center border-t border-t-blue-900/10 dark:bg-gradient-to-b dark:from-[#0a0817] dark:to-[#060012]'>
                <h2 className='mb-12 mt-52'>Looking to Clean Up your Money?</h2>
                <motion.div initial={{ y: -30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, delay: 0.25 }}>
                    <h1 className='gradient-bg bg-black bg-clip-text text-3xl font-semibold tracking-tighter text-transparent dark:bg-gradient-to-r md:text-6xl xl:text-8xl'>Welcome to your </h1>
                </motion.div>
                <motion.div className='gradient-bg flex bg-black bg-clip-text text-3xl font-semibold tracking-tighter text-transparent dark:bg-gradient-to-r md:text-6xl xl:text-8xl'>
                ...
                <motion.div initial={{ y: 0, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1.5, delay: 1.75 }} className='mt-12 flex flex-col items-center'>
                    <span className='text-2xl text-zinc-700 dark:text-zinc-400'>Keep track of your finances.</span>
                    <span className='text-2xl text-zinc-700 dark:text-zinc-400'>Watch your money grow.</span>
                </motion.div>
