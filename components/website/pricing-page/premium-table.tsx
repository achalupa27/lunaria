...
const PremiumTable = ({ term, onSignUpClick }: Props) => {
    ...
    return (
        <div className='gold-gradient relative flex h-auto sm:h-[36rem] w-full sm:w-[22rem] flex-col rounded-2xl border border-orange-200 p-1 dark:bg-black dark:text-black'>
