...
const TermChanger = ({ term, setTerm }: Props) => {
    return (
        <>
            <div className='relative flex w-72 sm:w-96 rounded-full border border-orange-50 bg-white p-[4px] shadow dark:bg-black'>
                {/* Sliding Background */}
            ...
            <div className='mt-3 flex items-center justify-center'>
                <div className='whitespace-nowrap rounded-full bg-orange-100 px-5 py-1 text-center text-sm sm:text-base font-semibold text-black'>
