    ...
    return (
        <section className='flex flex-col items-center justify-center py-24 text-center'>
            ...
            <motion.p initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1.2, delay: 0.3 }} className='mb-8 max-w-2xl text-lg text-gray-500'>
                Lunaria helps you track, manage, and grow your wealth effortlessly. Take control of your financial future today.
            </motion.p>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5, delay: 0.9 }} className='rounded-xl border aspect-video border-orange-100 dark:border-orange-200 shadow-lg w-full h-full mt-10 bg-white'></motion.div>
        </section>
    );
};
