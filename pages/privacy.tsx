...
function PrivacyPolicy() {
    return (
        <div className='flex min-h-screen justify-center '>
            <Head>
                <title>lunaria - Privacy Policy</title>
            </Head>
            <article className='max-w-2xl'>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to lunaria.
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6 underline'>Collecting and Using Your Personal Data</h2>
                <h2 className='flex w-full justify-center py-6'>Types of Data Collected</h2>
                <h3>Personal Data</h3>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Usage Data</h2>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6 text-center'>Information from Third-Party Social Media Services</h2>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Tracking Technologies and Cookies</h2>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Use of Your Personal Data</h2>
                ...
                <ul>
                    ...
                    <li>
                        <strong>With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures
                        and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You and view Your profile.
                    </li>
                    <li>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Retention of Your Personal Data</h2>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Transfer of Your Personal Data</h2>
                <p>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Delete Your Personal Data</h2>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Disclosure of Your Personal Data</h2>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Security of Your Personal Data</h2>
                <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Children&apos;s Privacy</h2>
                <p>
                ...
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Links to Other Websites</h2>
                <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&apos;s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
                <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
                <br></br>
                <h2 className='flex w-full justify-center py-6'>Changes to this Privacy Policy</h2>
                ...
                <p className='text-center'>If you have any questions about this Privacy Policy, You can contact us:</p>
