...
import { selectTab, setTab } from '@/store/slices/tab-slice';
...
const Sidebar = () => {
    ...
    return (
        <div className='flex h-screen flex-col items-center justify-center space-y-4 bg-zinc-100 dark:bg-zinc-920 dark:border-r-orange-200 border-r px-2 py-3'>
